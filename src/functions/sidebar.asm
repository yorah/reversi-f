...
updateScoreInSidebar 	SUBROUTINE
	...
	DRAW_DIGIT PLAYER1_COLOR, 74, 31, 1, PLAYER1_SCORE
	DRAW_DIGIT PLAYER1_COLOR, 78, 31, 0, PLAYER1_SCORE

	DRAW_DIGIT PLAYER2_COLOR, 86, 31, 1, PLAYER2_SCORE
	DRAW_DIGIT PLAYER2_COLOR, 90, 31, 0, PLAYER2_SCORE
...
updateBoScoreInSidebar 	SUBROUTINE
	...
	DRAW_DIGIT PLAYER1_COLOR, 77, 48, 1, GAME_SCORE
	DRAW_DIGIT PLAYER2_COLOR, 87, 48, 0, GAME_SCORE
